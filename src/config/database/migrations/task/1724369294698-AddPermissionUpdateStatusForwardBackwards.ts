...
export class AddPermissionUpdateStatusForwardBackwards1724369294698
	implements MigrationInterface
{
	permissions = [
		{
			target: 'tasks.updateStatusForward',
			resource: 'tasks',
		},
		{
			target: 'tasks.updateStatusBackward',
			resource: 'tasks',
		}        
	];
	...
	roles = [
		{
			...
			permissions: [
				'tasks.updateStatusForward',
				'tasks.updateStatusBackward'						
			],
		},		
		{
			name: 'supervisor',
